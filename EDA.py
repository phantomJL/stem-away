...
class CarTalkWebscraper:
    ...
    def get_category_and_tags(self, topicSoup):    
        ...
        tagAnchors = topicCategoryDiv.find_all('a',class_='discourse-tag bullet')
    ...
    def runApplication(self, baseURL):
        ...
        # for categoryURL in categoryPageURLs[7:8]:
            ...
            # topicPageURLs = []
            print("Finding topic for No." ,i,"category")
            for i in range(len(topicAnchors)):
                topic_href = topicAnchors[i]['href']
            ...
            # for topicURL in topicPageURLs:
                ...
                self.driver.get(baseURL + topic_href)
